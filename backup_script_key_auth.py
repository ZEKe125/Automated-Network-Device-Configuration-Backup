...
private_key_path = '/path/to/your/ssh/key.pem'  # Path to your .pem private key file
...
def backup_device_config():
    try:
        ...
        # Connect to the network device using SSH key authentication
        ssh.connect(device_ip, port=device_port, username=device_username, pkey=private_key)
